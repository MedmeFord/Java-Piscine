...
public class UsersArrayList implements UsersList{
	static private int BASE_CAPCITY;
	private User[] initial_massive;

	UsersArrayList(int BASE_CAPCITY) {
		this.BASE_CAPCITY = BASE_CAPCITY;
		initial_massive = new User[BASE_CAPCITY];
	}
